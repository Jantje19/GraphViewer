onmessage = evt => {
	...
	for (let i = 0; i < lines[0].length - 1; i++) {
		try {
			...
			data.push(checkLineIntersection(line1StartX, line1StartY, line1EndX, line1EndY, line2StartX, line2StartY, line2EndX, line2EndY));
		} catch(err) {break;}
	}
...
function processData(data) {
	...
	data.forEach((object, key) => {
		if (object.onLine1 || object.onLine2)
